...
public class PWeightCalculator {
    ...
    public PWeightCalculator(String vectorFolder, String distFolder, boolean mpi, int distanceType, boolean sharedInput, int threads) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            if (singleFile == null) {
                ...
                PWeightCalculator program = new PWeightCalculator(_vectorFile, _distFile, mpi, distanceType, sharedInput, threads);
                program.process();
                if (mpi) {
                    MPI.Finalize();
                }
