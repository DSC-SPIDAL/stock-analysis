...
public class NeedlemanWunschSection extends Section
{
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	private String _summaryFile = "$(OutputRootPath)\\nw_summary.txt";
	private String _timingFile = "$(OutputRootPath)\\nw_timing.txt";
	private String _writeAlignmentFile = "$(OutputRootPath)\\nw_alignments.txt";
