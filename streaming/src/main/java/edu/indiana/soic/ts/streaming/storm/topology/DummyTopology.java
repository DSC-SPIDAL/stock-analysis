...
import edu.indiana.soic.ts.streaming.storm.bolt.DummyBolt;
...
public class DummyTopology {
    private final static Logger logger = LoggerFactory.getLogger(DummyTopology.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("dummyTopo1", new DummyBolt(), boltTasks)
                .shuffleGrouping("hbaseSpout");

        builder.setBolt("dummyTopo2", new DummyBolt(), boltTasks)
                .shuffleGrouping("dummyTopo1");

        builder.setBolt("dummyTopo3", new DummyBolt(), boltTasks)
                .shuffleGrouping("dummyTopo2");
