...
public class InsertDateReducer extends TableReducer<Text, Text, ImmutableBytesWritable> {
    private static final Logger log = LoggerFactory.getLogger(InsertDateReducer.class);
    @Override
