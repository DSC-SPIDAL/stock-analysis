...
import edu.indiana.soic.ts.crunch.utils.CrunchUtils;
...
public class CrunchDateInserter extends Configured implements Tool, Serializable {
    private static final Logger log = LoggerFactory.getLogger(CrunchDateInserter.class);
    public static void main(final String[] args) throws Exception {
        final int res = ToolRunner.run(new Configuration(), new CrunchDateInserter(), args);
        System.exit(res);
    }
    ...
    public int run(final String[] args) throws Exception {
        ...
        final Pipeline pipeline = new MRPipeline(CrunchDateInserter.class,
