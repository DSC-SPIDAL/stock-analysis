...
$BUILD/bin/mpirun --report-bindings java -cp ../mpi/target/stocks-1.0-ompi1.8.1-jar-with-dependencies.jar ContinuousCommonGenerator -v $CONT_VECS -p $CONT_POINTS -d $CONT_COMMON_POINTS -sf $ORIGINAL_STOCK_FILE -s "UNH,GS,CVX,MCD,BA,GE,WMT,INTC,MSFT,IBM" -s 20040101 -e 20150101 -m | tee $BASE_DIR/$POSTPROC_INTERMEDIATE_DIR_NAME/common.points.out.txt
