...
java -cp ../mpi/target/stocks-1.0-ompi1.8.1-jar-with-dependencies.jar CCommonGenerator -v $CONT_VECS -p $CONT_POINTS -d $CONT_COMMON_POINTS -r $FINAL_ROTATE -sd 20040101 -ed 20151231 -l -md 7 -i $ORIGINAL_STOCK_FILE | tee $BASE_DIR/$POSTPROC_INTERMEDIATE_DIR_NAME/common.points.list.out.txt
