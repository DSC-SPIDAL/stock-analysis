...
$BUILD/bin/mpirun --report-bindings --mca btl ^tcp java -cp  ../mpi/target/stocks-1.0-ompi1.8.1-jar-with-dependencies.jar SHeatMapGenerator -c heatmap.properties -o $YEARLY_HEATMAP_DIR -m -p $BASE_DIR/$YEARLY_MDS_DIR_NAME -d YEARLY_DISTANCES_DIR -sa 4.0 -sb 4.0
